...
import { k as clamp, ab as chunk, ac as padEnd, l as consoleWarn, X as has, L as templateRef, I as IN_BROWSER, p as propsFactory, c as convertToUnit, j as getCurrentInstance, o as findChildrenWithProvide, a1 as getObjectValueByPath, B as consoleError, u as useProxiedModel, a7 as mergeDeep, Z as createRange, g as genericComponent, C as defineComponent, f as getCurrentInstanceName, ad as SUPPORTS_TOUCH, a6 as refElement, ae as padStart } from './proxiedModel-BTFJLt0u.js';
...
// Utilities
const {onBeforeUnmount: onBeforeUnmount$1,readonly,ref: ref$4,watch: watch$3} = await importShared('vue');
function useResizeObserver(callback) {
  let box = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'content';
  const resizeRef = templateRef();
  const contentRect = ref$4();
  if (IN_BROWSER) {
    ...
    watch$3(() => resizeRef.el, (newValue, oldValue) => {
      if (oldValue) {
...
const {computed: computed$4,inject: inject$6,onActivated,onBeforeUnmount,onDeactivated,onMounted,provide: provide$2,reactive: reactive$2,ref: ref$3,shallowRef: shallowRef$3,toRef: toRef$4,useId} = await importShared('vue');
...
function useLayoutItem(options) {
  ...
  const {
    ...
    ...options,
    active: computed$4(() => isKeptAlive.value ? false : options.active.value),
    id
  });
...
function createLayout(props) {
  ...
  const rootZIndex = computed$4(() => parentLayout ? parentLayout.rootZIndex.value - 100 : ROOT_ZINDEX);
  const registered = ref$3([]);
  ...
  const computedOverlaps = computed$4(() => {
    const map = new Map();
  ...
  const transitionsEnabled = computed$4(() => {
    return !Array.from(disabledTransitions.values()).some(ref => ref.value);
  });
  const mainRect = computed$4(() => {
  ...
  provide$2(VuetifyLayoutKey, {
    register: (vm, _ref2) => {
      ...
      const index = computed$4(() => items.value.findIndex(i => i.id === id));
      const zIndex = computed$4(() => rootZIndex.value + layers.value.length * 2 - index.value * 2);
      const layoutItemStyles = computed$4(() => {
      ...
      const layoutItemScrimStyles = computed$4(() => ({
...
export { useDate as A, createDateRange as B, provideLocale as C, useLayout as D, VClassIcon as E, VComponentIcon as F, VLigatureIcon as G, HexToHSV as H, IconValue as I, VSvgIcon as J, createDisplay as K, createTheme as L, createIcons as M, createLocale as N, createDate as O, createGoTo as P, DisplaySymbol as Q, RGBtoHSV as R, IconSymbol as S, ThemeSymbol as T, LocaleSymbol as U, VuetifyLayoutKey as V, DateOptionsSymbol as W, DateAdapterSymbol as X, GoToSymbol as Y, makeLayoutProps as a, isParsableColor as b, createLayout as c, parseColor as d, useLayoutItem as e, makeLayoutItemProps as f, getForeground as g, useTheme as h, isCssColor as i, useIcon as j, useResizeObserver as k, useLocale as l, makeThemeProps as m, useDisplay as n, useGoTo as o, provideTheme as p, makeDisplayProps as q, HSVtoHex as r, HSLtoHSV as s, HSVtoHSL as t, useRtl as u, HSVtoRGB as v, HSVtoCSS as w, RGBtoCSS as x, getContrast as y, breakpoints as z };
