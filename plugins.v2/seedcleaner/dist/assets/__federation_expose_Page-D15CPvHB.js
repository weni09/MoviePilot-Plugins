...
import { f as formatBytes, O as ONLY_TORRENT, A as ALL, a as ONLY_DATA, P as PLUGIN_ID } from './definedFunctions-DC-6eV6J.js';
...
const _hoisted_2 = { class: "div-radio-group" };
const _hoisted_3 = { class: "div-radio-group" };
              ...
              _createVNode$3(_component_v_col, { cols: "10" }, {
                default: _withCtx$3(() => [
                  _createVNode$3(_component_v_radio_group, {
                    ...
                    default: _withCtx$3(() => [
                      _createElementVNode$3("div", _hoisted_2, [
                        _createVNode$3(_component_v_radio, {
                          label: "全部",
                          value: "all"
                        }),
              ...
              _createVNode$3(_component_v_col, { cols: "10" }, {
                default: _withCtx$3(() => [
                  _createVNode$3(_component_v_radio_group, {
                    ...
                    default: _withCtx$3(() => [
                      _createElementVNode$3("div", _hoisted_3, [
                        _createVNode$3(_component_v_radio, {
                          label: "否",
                          value: false
                        }),
...
const ToolBar = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-cfc96171"]]);

const {defineComponent:_defineComponent$2} = await importShared('vue');

const {createElementVNode:_createElementVNode$2,toDisplayString:_toDisplayString$2,createTextVNode:_createTextVNode$2,resolveComponent:_resolveComponent$2,withCtx:_withCtx$2,openBlock:_openBlock$2,createBlock:_createBlock$1,createCommentVNode:_createCommentVNode$1,createVNode:_createVNode$2,renderList:_renderList$1,Fragment:_Fragment$1,createElementBlock:_createElementBlock$2,unref:_unref$1} = await importShared('vue');
      ...
      return _openBlock$2(), _createBlock$1(_component_v_card, {
        ...
        default: _withCtx$2(() => [
          _createVNode$2(_component_v_card_title, { class: "text-subtitle-1 d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
            default: _withCtx$2(() => [
              _cache[6] || (_cache[6] = _createElementVNode$2("span", null, "扫描记录列表", -1)),
                ...
                default: _withCtx$2(() => [
                  _createElementVNode$2("thead", null, [
                    _createElementVNode$2("tr", null, [
                      ...
                      _cache[7] || (_cache[7] = _createElementVNode$2("th", { class: "text-left" }, "名称", -1)),
                      _cache[8] || (_cache[8] = _createElementVNode$2("th", { class: "text-left" }, "状态", -1)),
                      _cache[9] || (_cache[9] = _createElementVNode$2("th", { class: "text-left" }, "大小", -1))
                    ])
                  ]),
                  _createElementVNode$2("tbody", null, [
                    (_openBlock$2(true), _createElementBlock$2(_Fragment$1, null, _renderList$1(props.scanRes.combinedList, (item) => {
                      return _openBlock$2(), _createElementBlock$2("tr", {
                        ...
                        _createElementVNode$2("td", null, _toDisplayString$2(item.size ? `${_unref$1(formatBytes)(item.size)}` : "未知大小"), 1)
                      ]);
                    }), 128))
                  ])
                ]),
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const deleteOptionText = (item) => {
      ...
      } else if (item?.type == "torrent" && item?.removeOption === ONLY_DATA && !item.data_missing || item?.type == "file") {
        return {
          text: "仅源文件",
          color: "warning"
        };
      } else if (item?.type == "torrent" && item?.removeOption === ONLY_DATA && item.data_missing) {
        return {
          text: "无源文件",
          color: "error"
        };
          ...
          _createVNode$1(_component_v_card_text, { class: "pa-0" }, {
            default: _withCtx$1(() => [
              _createVNode$1(_component_v_table, {
                ...
                default: _withCtx$1(() => [
                  _cache[6] || (_cache[6] = _createElementVNode$1("thead", null, [
                    _createElementVNode$1("tr", null, [
                      _createElementVNode$1("th", { class: "text-left" }, "名称"),
                      _createElementVNode$1("th", { class: "text-left" }, "删除选项"),
                      _createElementVNode$1("th", { class: "text-left" }, "大小"),
                      _createElementVNode$1("th", { class: "text-right" }, "操作")
                    ])
                  ], -1)),
                    ...
                    (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(state.cleanupList, (item) => {
                      return _openBlock$1(), _createElementBlock$1("tr", {
                        ...
                        item.type == "torrent" ? (_openBlock$1(), _createElementBlock$1(_Fragment, { key: 0 }, [
                          ...
                          _cache[3] || (_cache[3] = _createElementVNode$1("td", null, "仅源文件", -1)),
                          _createElementVNode$1("td", null, _toDisplayString$1(_unref(formatBytes)(item.size)), 1)
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const startScan = (isPageChange = false) => {
      console.log("开始扫描", `扫描参数: ${toolbarRef.value.state},isPageChange: ${isPageChange}`);
      state.scaning = true;
      if (!isPageChange) {
        state.scanParams.page = 1;
      }
      let url = `plugin/${PLUGIN_ID}/scan?page=${state.scanParams.page}&limit=${state.scanParams.pageSize}&pageChange=${isPageChange}`;
      props.api.post(url, toolbarRef.value.state).then((res) => {
        state.scanRes.combinedList = res.combined_list || [];
        state.scanRes.total = res.total || 0;
        state.scanRes.tTotal = res.t_total || 0;
        state.scanRes.mTotal = res.m_total || 0;
        state.scanRes.page = res.page || 1;
        state.scanRes.pageSize = res.page_size || 50;
        setTab("scan");
      }).catch((error) => {
          ...
          default: _withCtx(() => [
            ...
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                ...
                _withDirectives(_createVNode(_sfc_main$2, {
                ...
                _withDirectives(_createVNode(_sfc_main$1, {
                  ref_key: "cleanupRef",
                  ref: cleanupRef
                }, null, 512), [
...
const PageComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10f2d730"]]);
