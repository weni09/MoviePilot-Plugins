...
const VCheckbox = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return _createVNode$f(VInput, _mergeProps$a({
        ...
        default: _ref2 => {
          ...
          return _createVNode$f(VCheckboxBtn, _mergeProps$a(checkboxProps, {
            "id": id.value,
...
const VRadio = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return _createVNode$e(VSelectionControl, _mergeProps$9(controlProps, {
...
const {Fragment:_Fragment$4,createVNode:_createVNode$d,mergeProps:_mergeProps$8,createElementVNode:_createElementVNode$a} = await importShared('vue');
...
const VRadioGroup = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return _createVNode$d(VInput, _mergeProps$8({
        ...
        default: _ref2 => {
          ...
          return _createElementVNode$a(_Fragment$4, null, [label && _createVNode$d(VLabel, {
            ...
            default: () => [label]
          }), _createVNode$d(VSelectionControlGroup, _mergeProps$8(controlProps, {
            "id": id.value,
            "aria-describedby": messagesId.value,
...
const {mergeProps:_mergeProps$7,createVNode:_createVNode$b,createElementVNode:_createElementVNode$8,normalizeClass:_normalizeClass$4,normalizeStyle:_normalizeStyle$4} = await importShared('vue');
...
const VPagination = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => _createVNode$b(props.tag, {
      ...
      }, [slots.first ? slots.first(controls.value.first) : _createVNode$b(VBtn, _mergeProps$7({
        "_as": "VPaginationBtn"
      }, controls.value.first), null)]), _createElementVNode$8("li", {
        "key": "prev",
        "class": "v-pagination__prev",
        "data-test": "v-pagination-prev"
      }, [slots.prev ? slots.prev(controls.value.prev) : _createVNode$b(VBtn, _mergeProps$7({
        "_as": "VPaginationBtn"
      ...
      }, [slots.item ? slots.item(item) : _createVNode$b(VBtn, _mergeProps$7({
        "_as": "VPaginationBtn"
      }, item.props), {
        default: () => [item.page]
      ...
      }, [slots.next ? slots.next(controls.value.next) : _createVNode$b(VBtn, _mergeProps$7({
        "_as": "VPaginationBtn"
      }, controls.value.next), null)]), props.showFirstLastPage && _createElementVNode$8("li", {
        "key": "last",
        "class": "v-pagination__last",
        "data-test": "v-pagination-last"
      }, [slots.last ? slots.last(controls.value.last) : _createVNode$b(VBtn, _mergeProps$7({
        "_as": "VPaginationBtn"
...
const {mergeProps:_mergeProps$6,createVNode:_createVNode$9} = await importShared('vue');
const {computed: computed$7,mergeProps,ref: ref$3,toRef: toRef$2,useId} = await importShared('vue');
...
const VTooltip = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const overlay = ref$3();
    const location = computed$7(() => {
      return props.location.split(' ').length > 1 ? props.location : props.location + ' center';
    });
    const origin = computed$7(() => {
    ...
    const activatorProps = computed$7(() => mergeProps({
      'aria-describedby': id.value
    }, props.activatorProps));
    useRender(() => {
      const overlayProps = VOverlay.filterProps(props);
      return _createVNode$9(VOverlay, _mergeProps$6({
        "ref": overlay,
        "class": ['v-tooltip', {
...
const {createElementVNode:_createElementVNode$6,createTextVNode:_createTextVNode$2,withCtx:_withCtx$2,createVNode:_createVNode$8,toDisplayString:_toDisplayString$2,openBlock:_openBlock$2,createBlock:_createBlock$1,createCommentVNode:_createCommentVNode$1,renderList:_renderList$1,Fragment:_Fragment$3,createElementBlock:_createElementBlock$2,withModifiers:_withModifiers$1,mergeProps:_mergeProps$5,unref:_unref$1} = await importShared('vue');
...
const {computed: computed$6,reactive: reactive$2} = await importShared('vue');
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const totalComputed = computed$6(() => {
      let res = [];
    ...
    const allScanKeys = computed$6(() => {
      const Keys = props.scanRes.combinedList.map((item) => item.hash);
      return [...Keys];
    });
    const selectAllScans = computed$6({
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock$2(), _createBlock$1(VCard, {
        ...
        default: _withCtx$2(() => [
          _createVNode$8(VCardTitle, { class: "text-subtitle-1 d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
            default: _withCtx$2(() => [
              _cache[7] || (_cache[7] = _createElementVNode$6("span", null, "扫描记录", -1)),
              _createVNode$8(VBtn, {
                color: "primary",
              ...
              _createVNode$8(VSpacer),
              _createVNode$8(VSelect, {
          ...
          _createVNode$8(VCardText, { class: "pa-0" }, {
            default: _withCtx$2(() => [
              _createVNode$8(VTable, {
                "fixed-header": "",
                height: "320px",
                density: "compact",
                hover: ""
                  ...
                  _createElementVNode$6("thead", null, [
                    _createElementVNode$6("tr", null, [
                      _createElementVNode$6("th", _hoisted_1$2, [
                        _createVNode$8(VCheckbox, {
                          modelValue: selectAllScans.value,
                          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => selectAllScans.value = $event),
                          "hide-details": ""
                        }, null, 8, ["modelValue"])
                      ]),
                      _cache[8] || (_cache[8] = _createElementVNode$6("th", { class: "text-left name-column" }, "名称", -1)),
                      _cache[9] || (_cache[9] = _createElementVNode$6("th", { class: "text-left" }, "Tracker", -1)),
                      _cache[10] || (_cache[10] = _createElementVNode$6("th", { class: "text-left" }, "状态", -1)),
                      _cache[11] || (_cache[11] = _createElementVNode$6("th", { class: "text-left size-column" }, "大小", -1))
                    ])
                  ]),
                    ...
                    (_openBlock$2(true), _createElementBlock$2(_Fragment$3, null, _renderList$1(props.scanRes.combinedList, (item) => {
                      return _openBlock$2(), _createElementBlock$2("tr", {
                        ...
                        _createElementVNode$6("td", _hoisted_2$1, [
                          _createVNode$8(VTooltip, { location: "bottom" }, {
                            activator: _withCtx$2(({ props: props2 }) => [
                              _createElementVNode$6("div", _mergeProps$5({ ref_for: true }, props2, { style: { "display": "flex", "align-items": "center" } }), [
                                item.hasOwnProperty("client") && item.client ? (_openBlock$2(), _createBlock$1(VChip, {
                                  key: 0,
                                ...
                                _createElementVNode$6("span", _hoisted_3$1, _toDisplayString$2(item.name), 1),
                                _createVNode$8(VBtn, {
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$6("span", null, _toDisplayString$2(item.path), 1)
                            ]),
                            _: 2
                          }, 1024)
                        ]),
                        item.type === "torrent" ? (_openBlock$2(), _createElementBlock$2(_Fragment$3, { key: 0 }, [
                          ...
                          _cache[13] || (_cache[13] = _createElementVNode$6("td", null, "无 Tracker", -1)),
                          _createElementVNode$6("td", null, [
                            _createVNode$8(VChip, {
                              color: "warning",
                              size: "small",
                        ...
                        _createElementVNode$6("td", _hoisted_4$1, _toDisplayString$2(item.size ? `${_unref$1(formatBytes)(item.size)}` : "未知大小"), 1)
                      ]);
                    }), 128))
                  ])
                ]),
                    ...
                    (_openBlock$1(true), _createElementBlock$1(_Fragment$2, null, _renderList(state.cleanupList, (item) => {
                      return _openBlock$1(), _createElementBlock$1("tr", {
                        ...
                        _createElementVNode$5("td", _hoisted_1$1, [
                          _createVNode$7(VTooltip, { location: "bottom" }, {
                            activator: _withCtx$1(({ props }) => [
                              _createElementVNode$5("div", _mergeProps$4({ ref_for: true }, props, { style: { "display": "flex", "align-items": "center" } }), [
                                item.hasOwnProperty("client") && item.client ? (_openBlock$1(), _createBlock(VChip, {
                                  key: 0,
                                  color: item.hasOwnProperty("client") && item.client === "transmission" ? "primary" : "error",
                                  size: "small",
                                  "text-color": "white"
                                ...
                                _createElementVNode$5("span", _hoisted_2, _toDisplayString$1(item.name), 1),
                                _createVNode$7(VBtn, {
                                  icon: "mdi-content-copy",
                                  size: "x-small",
                            ...
                            default: _withCtx$1(() => [
                              _createElementVNode$5("span", null, _toDisplayString$1(item.path), 1)
                            ]),
                            _: 2
                          }, 1024)
                        ]),
                        item.type == "torrent" ? (_openBlock$1(), _createElementBlock$1(_Fragment$2, { key: 0 }, [
                          ...
                          _createElementVNode$5("td", _hoisted_3, _toDisplayString$1(_unref(formatBytes)(item.size)), 1)
                        ], 64)) : _createCommentVNode("", true),
                        _createElementVNode$5("td", _hoisted_4, [
                          _createVNode$7(VBtn, {
                            icon: "",
                            size: "small",
